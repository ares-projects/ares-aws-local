...
The first vertical slice reads one synthesized CloudFormation stack, plans dependencies,
provisions local SQS queues, and reports unsupported resources explicitly.
...
- [ ] M4: Add Lambda file-asset resolution and `AWS::Lambda::Function`.
- [ ] M5: Add event-source mappings and CloudFormation-compatible stack APIs.
